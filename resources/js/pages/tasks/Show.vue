        ...
        <div class="flex flex-col space-y-4 p-4">
            ...
            <div class="flex justify-between">
                <Link
                    ...
                    class="rounded-md bg-orange-600 px-3 py-2 text-sm font-bold text-white shadow-xs hover:bg-orange-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"
                >
                    Edit
                </Link>
                <button
