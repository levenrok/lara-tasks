        ...
        <form @submit.prevent="form.post('/tasks')">
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 py-4 dark:border-white/10">
                    ...
                    <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-400">Add a name, description and a date</p>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <Link href="/tasks" class="text-sm/6 font-semibold text-gray-900 dark:text-white">Cancel</Link>
                <button
                    type="submit"
